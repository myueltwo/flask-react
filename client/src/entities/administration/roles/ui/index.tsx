...
import {useGetRolesQuery, useDeleteRoleMutation} from "../model";
...
export const Roles: React.FC = () => {
    ...
    const {data, isLoading, isError, error} = useGetRolesQuery({page});
    const [deleteItem] = useDeleteRoleMutation();
    const props = {
