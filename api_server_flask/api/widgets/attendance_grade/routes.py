...
attendance_grade_ns = Namespace(
    name="attendance_grade", description="Store of grades by attendance"
)
add_models(
    attendance_grade_ns,
...
class AttendanceGradeList(Resource):
    ...
    @attendance_grade_ns.response(
        int(HTTPStatus.CREATED), "Added new grade by attendance."
    )
    @attendance_grade_ns.response(
    ...
    @attendance_grade_ns.response(
        HTTPStatus.OK, "Retrieved subject list.", pagination_attendance_grade_model
    )
...
@attendance_grade_ns.response(
    int(HTTPStatus.NOT_FOUND), "Grade by attendance not found."
)
...
class AttendanceGrade(Resource):
    ...
    @attendance_grade_ns.response(
        int(HTTPStatus.OK), "Retrieved subject.", attendance_grade_model
    )
    ...
    @attendance_grade_ns.response(
        int(HTTPStatus.OK), "Widget was updated.", attendance_grade_model
    )
